...
class MaskClassificationLoss(Mask2FormerLoss):
    ...
    def loss_total(self, losses_all_layers, log_fn) -> torch.Tensor:
        ...
        for loss_key, loss in losses_all_layers.items():
            log_fn(f"losses/train_{loss_key}", loss, sync_dist=True, on_step=False, on_epoch=True)
        ...
        log_fn("losses/train_loss_total", loss_total, sync_dist=True, prog_bar=True, on_step=False, on_epoch=True)
